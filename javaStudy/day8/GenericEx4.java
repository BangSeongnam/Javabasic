 ...
 * T extends SuperType 이렇게 선언하면, 반드시 Super의 하위 타입으로만 
 * 객체를 발생시킬수 있다.
 */
...
public class GenericEx4  {
	//오직 숫자타입의 값만 파라미터로 제한 시킬수 있도록 타입을 제한 합니다,
	...
	public static void doSome2(PersonGen<? extends AcademyStudent> pGen) {
		System.out.println(pGen.getClass());
	}
