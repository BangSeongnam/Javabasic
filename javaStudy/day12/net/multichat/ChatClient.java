		...
		Thread thread = new Thread(()->{
			try {
				while(true) {
					...
					jsonObject.put("id", "mineruwo");
					jsonObject.put("pwd", "qwer1234");
					jsonObject.put("total_cnt", 10);
					
					
					String jsonData = jsonObject.toString();
					
					JSONObject readObject = new JSONObject(jsonData);
					
					String savedId =readObject.get("id").toString();
					
					int total = readObject.getInt("total_cnt");
